...
public class ChatRoomActivity extends AppCompatActivity implements View.OnClickListener {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < res.length(); i++) {
                                ...
                                //Mudei as varíaveis para coincidir com a API
    ...
    private void sendMessage() {
        ...
        try {
            js.put("id",AppController.getInstance().getUserId());
            js.put("mensagem",message);
        } catch (JSONException e) {
            e.printStackTrace();
        }

        JsonObjectRequest jsonObjectReq = new JsonObjectRequest(Request.Method.POST, URLs.URL_SEND_MESSAGE, js,
